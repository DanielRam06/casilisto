...
public class MyWindow extends JFrame implements ActionListener, MouseListener, ChangeListener {
	...
	lbl.setFont(new Font("Serif", Font.PLAIN, 70)); // Establece la fuente de la etiqueta 'lbl'

	canvas.setBounds((width / 2) - 250, (height / 2) - 300, 500, 500); // Establece los límites del lienzo

	createArtLabel = new JLabel("Crea tu propio arte"); // Crea una nueva etiqueta con el texto "Crea tu propio arte"
	createArtLabel.setBounds(canvas.getX(), canvas.getY() - 20, 200, 20); // Establece los límites de la etiqueta 'createArtLabel'
